...
horlogeData[1].textContent = Math.round(data["qteOmgBooks"][numberHorloge[0].textContent.substr(1) - 1][1993 + parseInt(numberHorloge[0].textContent.substr(1))]) + " × 10⁻⁶ %";
...
numberHorloge.forEach(element => {
  element.addEventListener('click', () => {
    ...
    horlogeData[1].textContent = Math.round(data["qteOmgBooks"][element.textContent.substr(1) - 1][1993 + parseInt(element.textContent.substr(1))]) + " × 10⁻⁶ %";
